...
- **What did I implement this week?**
  - [ ] Forked, cloned and set up repo in GitHub
  - [ ] Looked through API:s
  - [ ] Tried to come up with a project idea
  - [ ] Landed on creating a small weather app

- **What obstacles or roadblocks did I face this week?**

  - [x] Technical challenges, figuring out which API should work well and also be free. Never worked with external (not company provided) API:s before
  - [x ] Time constraints
...
- **Is there anything in particular that I would benefit from reviewing with the code instructor to enhance or solve my obstacles or roadblocks of the week?**
  - [x] Yes, how to work with API calls in React, only done it with pure javascript before
  - [ ] No
